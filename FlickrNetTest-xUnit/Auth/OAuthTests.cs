...
namespace FlickrNetTest
{
    ...
    {
        [Fact(Skip="Use this to generate a require token. Then add verifier to second test")]
        public void OAuthGetRequestTokenBasicTest()
        {
            ...
            Assert.NotNull(requestToken.Token);//, "Token should not be null."
            Assert.NotNull(requestToken.TokenSecret);//, "TokenSecret should not be null."
        ...
        [Fact(Skip="Use this to generate an access token. Substitute the verifier from above test prior to running")]
        ...
        public void OAuthCheckTokenTest()
        {
            ...
            Assert.Equal(a.Token, f.OAuthAccessToken);
        }
        ...
        public void OAuthCheckEncoding()
        {
            ...
            {
                Assert.Equal(pair.Value, UtilityMethods.EscapeOAuthString(pair.Key));
            }
        }
    }
}
